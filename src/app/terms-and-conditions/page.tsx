...
export const metadata: Metadata = {
    title: "Terms and Conditions | Contents.cafe",
...
const RefundStatement: React.FC = () => {
  return (
    ...
    <p>This website is operated by Evoura Technologies Private Limited. Throughout the site, the terms “we”, “us” and “our” refer to Evoura Technologies Private Limited. We offer this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
...
<Section title="SECTION 2 - GENERAL CONDITIONS">
    ...
    <p>You understand that your content (not including credit card information), may be transferred unencrypted and involve (a) transmissions over various networks; and (b) changes to conform and adapt to technical requirements of connecting networks or devices. Credit card information is always encrypted during transfer over networks. We use Stripe, Razorpay and Metamask for transactions. We are not liable for any refunds or actions if any kind of third-party related issues are raised.</p>
...
<Section title="SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY">
    ...
    <p>In no case shall Evoura Technologies Private Limited, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.</p>
</Section>
<Section title="SECTION 14 - INDEMNIFICATION">
    <p>You agree to indemnify, defend and hold harmless Evoura Technologies Private Limited and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
</Section>
...
<Section title="SECTION 18 - GOVERNING LAW">
    <p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of India and jurisdiction of Palakkad, Kerala.</p>
</Section>
...
<Section title="SECTION 20 - CONTACT INFORMATION">
    <p>Questions about the Terms of Service should be sent to us at contact@evoura.in with “QUERY” included in the Subject line.</p>
</Section>
